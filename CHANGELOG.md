...
- Avoid duplicate type-stub entries when generated `.pyi` files are already
  included as Python package data.

## [0.5.2] - 2026-08-31

- Include standards-compliant `PKG-INFO` metadata in source distributions so
  package indexes such as PyPI accept them.

## [0.5.1] - 2026-08-29

- New projects pin `nuwa_sdk@0.4.4` (buffer-flag and NumPy layout fixes).
